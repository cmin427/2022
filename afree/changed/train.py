...
# load data
raw_data = pd.read_csv(r'C:\Users\min\Desktop\project\A-free\changed\merge_data.csv', header=None) #header=0 지움
dataset = raw_data.values
# X = dataset[:, 0:36].astype(float)
# Y = dataset[:, 36]
X = dataset[:, 0:36].astype(float)  # Ignore run data
Y = dataset[:, 36]
...
# print(encoder_Y)
# print(encoder_Y[0], encoder_Y[900], encoder_Y[1800])
# print(encoder_Y[0], encoder_Y[9380], encoder_Y[11848])
...
# test
model = load_model('taekwondo_model.h5')
